...
with open('heart_disease_modell.sav','rb') as file:
...
if selected == 'Diabetes Prediction':
    ...
    if st.button('Diabetes Prediction Result'):
        ...
        user_input = [float(x) for x in user_input]  # Convert to floats
        ...
        if diabetes_prediction[0] == 1:
            ...
            iabetes_diagnosis = 'The person does not have diabetes'  
